...
EX void applyBoxes() {
  ...
  fakebox[boxid] = false;
  if(saving)
    applyBoxSave(specialland == laOcean ? laOcean :
                 items[itOrbSafety] ? safetyland : cwt.at->land, "@safetyland");
  ...
  if(saving) applyBoxSave(arc_startland, "euclid land");
